...
snakemake <- Snakemake(
    ...
    output = list('/shares/CIBIO-Storage/BCG/scratch/fgastaldello/data/cvep-plm/tumors/DLBC/mutated_sequences/nn/chr21.RData'),
    params = list(),
    wildcards = list('DLBC', '21', "cancer_type" = 'DLBC', "chr" = '21'),
    threads = 1,
    log = list(),
    resources = list(),

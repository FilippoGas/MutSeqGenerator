...
snakemake <- Snakemake(
    input = list('/shares/CIBIO-Storage/BCG/scratch/fgastaldello/resources/protein_coding_transcripts/wt_cds.RData', '/shares/CIBIO-Storage/BCG/scratch/fgastaldello/resources/protein_coding_transcripts/protein_coding_transcripts.RData', '/shares/CIBIO-Storage/BCG/scratch/fgastaldello/data/cvep-plm/temp/UVM_list.txt', '/shares/CIBIO-Storage/BCG/scratch/fgastaldello/data/cvep-plm/tumors/UVM/phased_vcf/chr10.vcf.gz', '/shares/CIBIO-Storage/BCG/scratch/fgastaldello/data/cvep-plm/tumors/UVM/phased_vcf/chr10.vcf.gz.tbi', "wt_cds" = '/shares/CIBIO-Storage/BCG/scratch/fgastaldello/resources/protein_coding_transcripts/wt_cds.RData', "annotations" = '/shares/CIBIO-Storage/BCG/scratch/fgastaldello/resources/protein_coding_transcripts/protein_coding_transcripts.RData', "samples_list" = c('/shares/CIBIO-Storage/BCG/scratch/fgastaldello/data/cvep-plm/temp/UVM_list.txt'), "vcf" = c('/shares/CIBIO-Storage/BCG/scratch/fgastaldello/data/cvep-plm/tumors/UVM/phased_vcf/chr10.vcf.gz'), "index" = c('/shares/CIBIO-Storage/BCG/scratch/fgastaldello/data/cvep-plm/tumors/UVM/phased_vcf/chr10.vcf.gz.tbi')),
    output = list('/shares/CIBIO-Storage/BCG/scratch/fgastaldello/data/cvep-plm/tumors/UVM/mutated_sequences/nn/chr10.RData'),
    params = list(),
    wildcards = list('UVM', '10', "cancer_type" = 'UVM', "chr" = '10'),
    threads = 1,
    log = list(),
    resources = list(),
